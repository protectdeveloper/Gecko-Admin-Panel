...
export default function CalendarBodyWeek() {
  ...
  return (
    <div className="flex divide-x flex-grow overflow-hidden border border-border rounded-xl h-[75vh]">
      <div className="flex flex-col flex-grow divide-y overflow-hidden">
        <div className="flex flex-col flex-1 overflow-y-auto">
          <div className="relative flex flex-1 divide-x flex-col md:flex-row">
            ...
            {weekDays.map((day) => (
              <div key={day.toString()} className="flex flex-1 divide-x md:divide-x-0">
